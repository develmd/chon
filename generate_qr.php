...
<body>
    ...
    <div class="container mt-4">
        <h1><i class="fas fa-qrcode"></i> Генерация QR-кодов для занятий</h1>
                ...
                <div class="col-md-7">
                    <div class="card border-success">
                        <div class="card-header bg-success text-white">
                            <h5>✅ QR-код готов к использованию!</h5>
                        </div>
                        <div class="card-body text-center">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="generate_qr.php" class="btn btn-secondary">
                                    <i class="fas fa-plus"></i> Сгенерировать еще
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card mt-4">
            <div class="card-header bg-warning text-dark">
                <h5><i class="fas fa-clock"></i> Активные QR-сессии</h5>
            </div>
            <div class="card-body">
