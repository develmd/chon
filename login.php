...
<head>
    ...
    <style>
        ...
        .card { background: #0f0f1a; border: none; border-radius: 20px; box-shadow: 0 10px 40px rgba(0,0,0,0.3); }
        .card-header { background: linear-gradient(45deg, #667eea, #764ba2); border-radius: 20px 20px 0 0 !important; }
        .form-control, .form-select { background: #1a1a2e; border: 1px solid #333; color: #fff; }
        .form-control:focus, .form-select:focus { background: #1a1a2e; color: #fff; border-color: #667eea; box-shadow: 0 0 0 0.25rem rgba(102,126,234,0.25); }
        .form-label { color: #fff !important; font-weight: 500; }
        .text-muted { color: #aaa !important; }
        .nav-tabs .nav-link { color: #ededed; background: transparent; border: none; }
        .nav-tabs .nav-link.active { color: #667eea; background: transparent; border-bottom: 2px solid #667eea; }
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="registerTab">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="alert alert-info" style="background: rgba(23,162,184,0.2); border: 1px solid #17a2b8; color: #6bc4d4;">
