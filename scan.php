...
if (!isset($_SESSION['student_id']) && isset($_GET['student_id'])) {
    $_SESSION['student_id'] = (int)$_GET['student_id'];
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['scan_qr'])) {
    try {
        ...
        if (!$student_id) {
            $error = "Сначала выберите студента!";
        } else {
    ...
    <div class="container mt-4 mb-4">
        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="text-muted">Выберите себя из списка</p>
                
                <form method="GET" class="mt-3">
                    <select name="student_id" class="form-select form-select-lg mb-3" required>
